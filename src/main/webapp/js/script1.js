function popup({
            ...
            if(main && hdoverlay){
                ...
                addCartBtn.addEventListener('click', function(e){
				    ...
				    $.ajax({
				        method: "POST",
				        url: "http://localhost:8080/FastFood2/api/buy",
        ...
        function showRatingFood(foodId){
			$.ajax({
				method: "GET",
				url: "http://localhost:8080/FastFood2/api/rating/getRating?foodId=" + foodId, 
		        dataType: "json",
			}).done(function(data){
		...
		function updateCart() {
		    $.ajax({
		        method: "GET",
		        url: "http://localhost:8080/FastFood2/api/item/updatecart", 
		        dataType: "json",
		    }).done(function(data) {
	...
	$(document).ready(function(){
		$(document).on('click', '.btn-xoa', function(){
			...
			$('.delOpt_yes').off('click').on('click', function(){
	            $.ajax({
	                method: "POST",
	                url: "http://localhost:8080/FastFood2/api/item/delete",
	                data: { foodId: foodId}
	            }).done(function(data) {
		...
		$(document).on('click', '.subCart_btn', function(){
			...
			if(currentQuantity > 1){
				$.ajax({
			        method: "POST",
			        url: "http://localhost:8080/FastFood2/api/item/changequantity",
		...
		/*$('.hdlogout').click(function(){
			$.ajax({
				method: "GET",
				url: "http://localhost:8080/FastFood2/logout"
			}).done(function(data){
	...
	function Redirect(key){
		window.location = "http://localhost:8080/FastFood2/menu?key=" + key;
	}
